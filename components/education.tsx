...
export async function Education({ isDetailedView = false }: EducationProps) {
  ...
  return (
    <section id="education" className="relative px-6 py-24 md:px-12 md:py-40">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto max-w-5xl">
          <Reveal>
            <article className="group flex flex-col items-center gap-10 md:flex-row md:gap-16">
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[1.75rem] md:w-1/2">
                <Image
              ...
              <div className="flex w-full flex-col pt-4 md:w-1/2 md:pt-0">
                ...
                <p 
                  className={`mt-6 text-pretty leading-relaxed text-muted-foreground whitespace-pre-line ${
